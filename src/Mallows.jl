module Mallows
    ...
    export sample_mallows_kendall_tau

    """
        sample_mallows_kendall_tau(n::Int, phi::Float64, sigma0::Vector{Int})

    Samples a permutation of size `n` from the Mallows model with Kendall's tau distance,
    ...
    """
    function sample_mallows_kendall_tau(n::Int, phi::Float64, sigma0::Vector{Int})
